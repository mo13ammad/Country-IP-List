...
:do { add address=2001:df7:4940::/48 list=BTv6 } on-error={}
:do { add address=2001:df7:63c0::/48 list=BTv6 } on-error={}
...
:do { add address=2402:70e0::/32 list=BTv6 } on-error={}
...
:do { add address=43.226.8.0/22 list=IP-BT } on-error={}
...
:do { add address=160.236.194.0/24 list=IP-BT } on-error={}
:do { add address=162.4.252.0/24 list=IP-BT } on-error={}
:do { add address=163.52.32.0/23 list=IP-BT } on-error={}
