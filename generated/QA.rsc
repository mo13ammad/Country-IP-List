...
:do { add address=2a06:cfc0::/32 list=QAv6 } on-error={}
...
:do { add address=2a0c:b2c0::/29 list=QAv6 } on-error={}
...
:do { add address=149.170.151.0/24 list=IP-QA } on-error={}
...
:do { add address=193.168.166.0/24 list=IP-QA } on-error={}
