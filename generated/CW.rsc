...
:do { add address=190.2.160.0/21 list=IP-CW } on-error={}
:do { add address=190.2.168.0/22 list=IP-CW } on-error={}
:do { add address=190.2.180.0/22 list=IP-CW } on-error={}
:do { add address=190.2.188.0/23 list=IP-CW } on-error={}
