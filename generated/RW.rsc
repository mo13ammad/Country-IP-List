...
:do { add address=2001:43ff:8800::/48 list=RWv6 } on-error={}
:do { add address=2001:43ff:a800::/48 list=RWv6 } on-error={}
...
:do { add address=2c0f:9a0::/32 list=RWv6 } on-error={}
...
:do { add address=102.202.79.0/24 list=IP-RW } on-error={}
